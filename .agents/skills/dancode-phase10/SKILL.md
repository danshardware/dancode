---
name: dancode-phase10
description: Dan's standardized methodology Phase 10 — Finalization. Land the feature branch on main cleanly with no commit history.
trigger: "/dancode-phase10"
---
