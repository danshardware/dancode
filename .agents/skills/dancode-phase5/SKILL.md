---
name: dancode-phase5
description: Dan's standardized methodology Phase 5 — QA. Independently verify that the code produced matches the plan, follows standards, and cannot be passed by a fake implementation.
trigger: "/dancode-phase5"
---
