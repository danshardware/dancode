---
TASK: Restart Modal Widget
SOURCE PLAN: Planning/usability-improvements/track-b/004-restart-modal-widget.md
---

Read the source plan file listed above. Then:

1. Create a git branch named `FEATURE/004-restart-modal-widget` based off the current branch.
...
4. Commit with message: "004-restart-modal-widget: Restart Modal Widget — initial implementation"

5. Write the tests described in "Testing Plan". Run them. Fix any failures.

6. Commit with message: "004-restart-modal-widget: Restart Modal Widget — tests passing"
...
9. Final commit with message: "004-restart-modal-widget: Restart Modal Widget — complete"
